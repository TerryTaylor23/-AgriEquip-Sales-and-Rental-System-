...
<body>
	<h2 style="background-color:#009688; color:white; text-align:center; font-size:56px">
     ...
     <a href="vendorlist.php" class="btn btn-info" style="position: relative;">Vendors</a>
     <?php
         $con = mysqli_connect("localhost","root","","agriculture");
        $sql1 = "SELECT * FROM user WHERE user_type = 'user'";
	 ...
	 <th>Firstname</th><th>lastname</th><th>Gender</th><th>Phonenumber</th>
	 </tr>
	 <?php
